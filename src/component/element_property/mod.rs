...
pub fn read_properties(
    properties: &IndexMap<String, Model<ElementProperty>>,
    cx: &mut AppContext,
...
pub fn insert_property(
    ...
    properties: &mut IndexMap<String, Model<ElementProperty>>,
    cx: &mut AppContext,
) {
    properties.insert(id.to_string(), cx.new_model(|_| value));
}
